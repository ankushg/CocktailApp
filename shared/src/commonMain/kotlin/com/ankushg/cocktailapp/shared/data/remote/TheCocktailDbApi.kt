...
import com.ankushg.cocktailapp.shared.data.remote.models.*
...
interface TheCocktailDbApi {
     ...
     */
    suspend fun cocktailsByIngredients(ingredient: Collection<Any>): CocktailSummaryResponse = throw UnsupportedOperationException()
     ...
     */
    suspend fun fetchRandomCocktails(): CocktailSummaryResponse = throw UnsupportedOperationException()

    /**
     *  List Popular cocktails (only available to $2+ Patreon supporters)
     *  https://www.thecocktaildb.com/api/json/v1/1/popular.php
     */
    suspend fun fetchPopularCocktails(): CocktailSummaryResponse = throw UnsupportedOperationException()

    /**
     * List most latest cocktails (only available to $2+ Patreon supporters)
     * https://www.thecocktaildb.com/api/json/v1/1/latest.php
     */
    suspend fun fetchLatestCocktails(): CocktailSummaryResponse = throw UnsupportedOperationException()
    // endregion
     ...
     */
    suspend fun ingredientsByName(query: String): IngredientResponse

    /**
     * https://www.thecocktaildb.com/api/json/v1/1/list.php?i=list
     */
    suspend fun indexIngredients(): IngredientResponse

    /**
     * Lookup ingredient by ID
     * https://www.thecocktaildb.com/api/json/v1/1/lookup.php?iid=552
     */
    suspend fun fetchIngredient(id: Int): IngredientResponse
